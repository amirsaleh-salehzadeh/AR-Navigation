...
/**
 * Handles the maths involved with vectors
 *
 * NOTE: Adapted from the Vector class of the free and open source Mixare framework (http://www.mixare.org/)
 */
public class Vector {

    // Array used to multiply vectors
    ...
    // Set using a predefined vector
    public void set(Vector v) {
        if (v==null) return;
        
        set(v.x, v.y, v.z);
    }
    // Set by passing all 3 values through at once
    ...
    // Both the above methods call the follwing method
    ...
    // Math Functions Relating to Vectors
