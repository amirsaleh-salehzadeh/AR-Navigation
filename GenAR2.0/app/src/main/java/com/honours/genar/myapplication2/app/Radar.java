...
import augmentation.PitchAzimuthCalculator;
import augmentation.ScreenPositionUtility;
import paintables.*;

/**
 * Used to draw the Radar including all elements (lines and points)
 */
public class Radar {
    ...
    private static final int LINE_COLOR = Color.argb(250, 0, 191, 255);
    private static final float PAD_X = 10;
    private static final float PAD_Y = 20;
    private static final int RADAR_COLOR = Color.argb(250, 89, 89, 89);
