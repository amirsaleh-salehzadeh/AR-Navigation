...
/**
 * Class used to calculate the pitch and azimuth from a given matrix
 *
 * Azimuth: Angle between the north vector and the perpendicular projection of the POI onto the horizon
 * see http://www.physics.csbsju.edu/astro/CS/images/CS.azimuth.t.gif
 */
