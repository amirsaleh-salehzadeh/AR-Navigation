...
import com.honours.genar.myapplication2.app.Vector;

/**
 * Represents the users location in the real world in three dimensions:
 * - Latitude
 * - Longitude
 * - Altitude
 */
public class PhysicalLocationUtility {
    ...
    // Variables to store the final 3D position data
    ...
    /**
     * Converts the user's location to a vector
     *
     * @param org User's Location
     * @param gp  PhysicalLocationUtility
     * @param v   Vector containing converted location
     */
